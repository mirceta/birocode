...
> the End User, including the legend follow-up. Browser-verified beforehand on
> the :5201 preview (`verify-agent-color.mjs`, 14/14 checks); colour
> round-trip re-verified on live after the bin swap.
