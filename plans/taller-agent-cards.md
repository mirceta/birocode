...
**Status:** Shipped & live — browser-verified on an isolated :5210 instance and
on live :5099; merged to main and deployed 2026-06-15 (rode along in the
`b9a0914` deploy alongside dashboard-title-button) on branch
