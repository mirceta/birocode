...
public class ArchAgentTests : IDisposable
{
    ...
    public void Mcp_tools_list_names_the_twenty_three_tools_with_required_args()
    {
        ...
        Assert.Equal(new[] { "list_agents", "list_machines", "git_state", "read_transcript", "send_task", "adopt_branch", "upgrade_peer", "list_loops", "start_loop", "update_loop", "stop_loop", "start_arch_goal", "list_arch_goals", "stop_arch_goal", "list_tasks", "create_task", "update_task", "assign_task", "dispatch_task", "delete_task", "list_ideas", "idea_to_task", "remember", "recall", "board_integrity", "flag_needs_human", "clear_needs_human" }, names);
