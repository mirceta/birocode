...
public class ArchAgentTests : IDisposable
{
    ...
    public void Mcp_catalogue_offers_machine_on_every_repo_addressed_tool()
    {
        ...
        Assert.Equal("<!-- arch-role v10 -->", ArchAgentService.RoleVersionMarker); // v10: multi-assignee tasks (openspec task-multi-assignee); v9: update_task moves the card, verification is advisory (openspec board-claims-advisory); v8/v7/v6 before
