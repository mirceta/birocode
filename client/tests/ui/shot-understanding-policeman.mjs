...
const mergeOk = merge.groups === 2 && merge.today === 3 && merge.one === 9 && merge.brains === 2 && merge.edges === 14;
...
console.log(JSON.stringify({ machine, click, startTab, tabAfterRef, whoMode, merge, mergeOk, partsOk, whoOk, machineOk, errs }));
