...
const TABS = ['arch', 'tasks', 'ideas', 'graph', 'kanban', 'recurring', 'events', 'status', 'settings'];
...
const DEFAULT_WEIGHTS = { arch: 2, tasks: 1, ideas: 1, graph: 1, kanban: 1, recurring: 1, events: 1, status: 1, settings: 1 };
