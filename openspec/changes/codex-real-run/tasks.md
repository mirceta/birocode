...
- [ ] 4.3 Authenticated end-to-end run (turn → harness MCP tool call → commit) — BLOCKED: no Codex credential on this machine; see the PR / task report for exactly what the Operator must provide and where
