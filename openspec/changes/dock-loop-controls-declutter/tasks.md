...
- [ ] 1.1 In `DockLoopControl.jsx`, add the Drive checkbox to `phone__loop-row`
...
- [ ] 3.2 Style the block in `autopilot.css` consistent with existing console
      sections

## 4. Verify

- [ ] 4.1 `npm --prefix client run build` clean
- [ ] 4.2 Headless browser check against an isolated preview: collapsed header
...
- [ ] 4.3 `openspec validate dock-loop-controls-declutter --strict` passes
