# github-pr-browser Specification

## Purpose
In-app GitHub PR drill-down on the events-app status board: repo tiles expand to an open-PR list and a native PR detail view, served through harness endpoints (PAT stays server-side).
## Requirements
