    ...
    public static JsonArray ToolsList() => new(
        ...
        Tool("create_task",
            ...
            Schema(("title", "string", "one line, what done looks like", true), ("note", "string", "details, acceptance criteria, links", false),
                ("machine", "string", "assignee's machine label or \"self\"", false), ("repoId", "string", "assignee repoId", false),
        ...
        Tool("assign_task",
            ...
            Schema(("id", "string", "task id", true), ("machine", "string", "machine label or \"self\"", false), ("repoId", "string", "repoId of the assignee (empty = unassign)", false))),
        Tool("dispatch_task",
        ...
        Tool("list_ideas",
            "The operator's Ideas list (Management → Ideas): id, text, project, priority, active. Active ideas are the ones meant to happen next; promote one with idea_to_task.",
        ...
        Tool("idea_to_task",
            ...
            Schema(("ideaId", "string", "idea id from list_ideas", true), ("title", "string", "optional sharper title", false), ("machine", "string", "assignee machine", false), ("repoId", "string", "assignee repoId", false))),
        Tool("remember",
